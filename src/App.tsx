  ...
  return (
    <div className="grid min-h-screen place-items-center bg-gradient-to-r from-slate-800 to-slate-700">
      <div className="w-11/12 max-w-4xl space-y-2 rounded-lg bg-slate-100 px-4 py-4 shadow-lg">
        ...
        <section className="flex flex-col-reverse space-y-3 sm:flex-row sm:space-y-0 sm:space-x-2">
          <div className="space-y-2 border-2 px-3 py-2 sm:w-1/2">
            <h2>필터</h2>
          ...
          <div className="flex items-center">
            <img src={placeholder} alt="preview-img" className="w-full" />
          </div>
        </section>
        ...
        <footer className="flex flex-col space-y-2 sm:flex-row sm:justify-between">
          ...
          <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-2">
            <button className="w-full rounded-md border-2 bg-slate-500 py-2 text-slate-100 transition hover:bg-slate-600 sm:w-36">
              이미지 올리기
            </button>
